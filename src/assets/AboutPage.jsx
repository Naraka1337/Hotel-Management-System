...
const AboutPage = () => {
    ...
    return (
        <motion.div className="min-h-screen bg-gradient-to-b from-gray-50 to-white" {...fadeIn}>
            {/* Hero Section */}
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div className="order-2 lg:order-1">
                                ...
                                <div className="flex items-center space-x-4">
                                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold shadow-lg">
                            ...
                            {values.map((value, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        whileHover={{ y: -8 }}
                                    >
                                        <div className="bg-gradient-to-br from-blue-500 to-purple-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
            ...
            <section className="py-20 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <Link to="/HotelsPage">
                        <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-10 py-4 rounded-xl text-lg font-bold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
                            Explore Hotels
                        </button>
                    </Link>
                </div>
