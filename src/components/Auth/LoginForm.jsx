...
const LoginForm = ({ setAuthView }) => {
  ...
  return (
    <motion.form onSubmit={handleLogin} className="space-y-6" {...fadeIn}>
      <motion.div className="text-center mb-8" {...slideUp}>
        <h2 className="text-4xl font-bold text-gray-900 mb-3 dark:text-white">Welcome Back</h2>
        <p className="text-gray-600 text-lg dark:text-gray-400">Sign in to book your next luxurious stay</p>
      </motion.div>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-white text-gray-500 dark:bg-gray-800 dark:text-gray-400 transition-colors duration-300">Or continue with</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          type="button"
          className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:bg-gray-600"
        >
