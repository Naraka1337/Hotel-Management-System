  ...
  return (
    <motion.form onSubmit={handleLogin} className="space-y-6" {...fadeIn}>
      <motion.div className="text-center mb-8" {...slideUp}>
        ...
        <p className="text-gray-600 text-lg">Sign in to book your next luxurious stay</p>
      </motion.div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          type="button"
          className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all"
        >
