...
export const createHotel = async (hotelData) => {
  const response = await axiosClient.post('/admin/hotels', hotelData);
  return response.data;
};

// Update hotel (admin)
export const updateHotel = async (hotelId, hotelData) => {
  const response = await axiosClient.put(`/admin/hotels/${hotelId}`, hotelData);
  return response.data;
};

// Delete hotel (admin)
export const deleteHotel = async (hotelId) => {
  const response = await axiosClient.delete(`/admin/hotels/${hotelId}`);
  return response.data;
};
